                    ...
                    <tr class="col-lg-6">
                      <td>
                        ...
                        <select id="productType" v-model="types" name="template" class="form-attribute">
                          <option v-for="types in findManyProduct_types" :key="types.id" :value="product_types">{{ types.name }}
                          </option>
                        </select>
                      </td>
                    </tr>
                    <tr class="col-lg-6">
                      <td>
                        ...
                        <select id="productAttribute" v-model="attributes" name="template" class="form-attribute">
                          <option v-for="attributes in attributes" :key="attributes.id" :value="product_attribute">
                    ...
                    <tr class="col-lg-6">
                      <td>
                        ...
                        <select id="category" v-model="manufacture">
                          <option v-for="manufacture in manufacturers" :key="manufacture.id" :value="manufacture">
                      ...
                      <div class="accordion-body">
                        <table class="table">
                          <tbody class="row">
                            ...
                            <tr class="col-lg-6">
                              <td>
                                <textarea v-model="meta_description" cols="50" rows="10" value="Add a Meta Description"></textarea>
                              </td>
                            </tr>
                            <tr class="col-lg-6">
                              <td>
