              ...
              <div class="table table-responsive">
                <table class="table">
                  <tbody class="row">
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Ticket Severity</label><br><br>
                      </td>
                      <td>
                    ...
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Stage of Ticket</label><br>
                      </td>
                      <td>
                    ...
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Ticket Name</label><br>
                      </td>
                      <td>
                    ...
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Ticket Department</label><br>
                      </td>
                      <td>
                    ...
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Account Name</label><br>
                      </td>
                      <td>
                    ...
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Priority</label><br>
                      </td>
                      <td>
                        <select id="ticketType" v-model="priority" name="template" class="form-category">
                    ...
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Requester</label><br>
                      </td>
                      <td>
                    ...
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Requester Email</label><br>
                      </td>
                      <td>
                        <input v-model="requester_email" type="email" required />
                      </td>
                    </tr>
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Ticket Date</label><br>
                      </td>
                      <td>
                    ...
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Ticket Description</label><br>
                      </td>
                      <td>
                    ...
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">For Website</label><br>
                      </td>
                      <td>
                        <input v-model="websites" type="url" />
                      </td>
                    </tr>
                    <tr class="col-lg-6">
                      <td>
                        <label for="type">Assigned To</label><br>
                      </td>
                      <td>
