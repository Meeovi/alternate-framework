                    ...
                    <tr>
                      ...
                      <td>
                        <select id="category" v-model="country" name="template" class="form-country">
                          <option v-for="country in findManyCountries" :key="country" :value="categories">
                            {{ country.name }}</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <select id="category" v-model="categories" name="template" class="form-category">
                          <option v-for="categories in findManyCategories" :key="categories" :value="categories">
                    ...
                    <tr>
                      ...
                      <td>
                        <select id="products" v-model="products" name="template" class="form-products">
                          <option v-for="products in findManyProducts" :key="products" :value="categories">
