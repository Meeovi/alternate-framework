<template>
    <div>
        <v-toolbar>
            <v-toolbar-title>Privacy and Security Settings</v-toolbar-title>
        </v-toolbar>
        ...
        <v-sheet>
            <v-row>
                ...
                <v-col cols="4">
                    <v-card href="/security/find-my-m-device">
                        <v-card-title>Find my M device</v-card-title>
                        <v-card-text>
