...
<template>
  <div my-8 px-3 sm:px-8 flex="~ col gap-4" relative>
    ...
    <template v-if="step === 'selectCategory'">
      ...
      <div>
        <v-text-field id="dontlike" v-model="reportReason" type="radio" value="dontlike">
      ...
      <div>
        <v-text-field id="spam" v-model="reportReason" type="radio" value="spam">
      ...
      <div v-if="serverRules.length > 0">
        <v-text-field id="violation" v-model="reportReason" type="radio" value="violation">
      ...
      <div>
        <v-text-field id="other" v-model="reportReason" type="radio" value="other">
      ...
      <div v-if="reportReason && reportReason !== 'dontlike'">
        ...
        <div v-if="getServerName(account) && getServerName(account) !== currentServer">
          ...
          <v-text-field id="forward" v-model="forwardReport" type="checkbox" value="rule.id">
