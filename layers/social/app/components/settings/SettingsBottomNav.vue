...
import type { NavButtonName } from '#social/app/composables/settings'
...
<template>
  <section space-y-2>
    ...
    <v-form aria-labelledby="interface-bn" aria-describedby="interface-bn-desc" @submit.prevent="save">
