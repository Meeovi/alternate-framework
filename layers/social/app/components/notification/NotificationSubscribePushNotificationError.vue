  ...
  >
    ...
    <p py-2>
      <i18n-t keypath="settings.notifications.push_notifications.subscription_error.error_hint">
        <NuxtLink font-bold href="https://docs.mframework.zone/pwa#faq" target="_blank" inline-flex="~ row" items-center gap-x-2>
          https://docs.mframework.zone/pwa#faq
          <span inline-block aria-hidden="true" i-ri:external-link-line class="rtl-flip" />
        </NuxtLink>
      </i18n-t>
    </p>
    <p py-2>
      <NuxtLink font-bold text-primary href="https://github.com/mframework-zone/mframework" target="_blank" flex="~ row" items-center gap-x-2>
