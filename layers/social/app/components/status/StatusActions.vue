  ...
  <div flex justify-between items-center class="status-actions">
    <div flex-1>
      <StatusActionButton
        ...
        color="text-blue" hover="text-blue" mframework-group-hover="bg-blue/10"
    ...
    <div flex-1>
      <StatusActionButton
        ...
        color="text-green" hover="text-green" mframework-group-hover="bg-green/10"
    ...
    <div flex-1>
      <StatusActionButton
        ...
        color="text-purple" hover="text-purple" mframework-group-hover="bg-purple/10"
    ...
    <div flex-1>
      <StatusActionButton
        ...
        :mframework-group-hover="useStarFavoriteIcon ? 'bg-yellow/10' : 'bg-rose/10'"
    ...
    <div flex-none>
      <StatusActionButton
        ...
        :mframework-group-hover="useStarFavoriteIcon ? 'bg-rose/10' : 'bg-yellow/10' "
