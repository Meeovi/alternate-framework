...
const { back = false } = defineProps<{
  /**
   * Should we show a back v-btn?
   * Note: this will be forced to false on xl screens to avoid duplicating the sidebar's back v-btn.
   */
  back?: boolean | 'small-only'
  /** Show the back v-btn on small screens */
