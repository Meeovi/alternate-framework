  ...
  <MainContent back="small-only">
    ...
    <template v-if="isHydrated">
      <SettingsItem
        ...
        :to="showCommit ? `https://github.com/mframework-zone/mframework/commit/${buildInfo.commit}` : undefined"
    ...
    <SettingsItem
      ...
      to="/m.webtoo.ls/@mframework"
      large target="_blank"
    />
    <SettingsItem
      text="Discord"
      icon="i-ri:discord-fill"
      to="https://chat.mframework.zone"
      external large target="_blank"
    />
    <SettingsItem
      text="GitHub"
      icon="i-ri:github-fill"
      to="https://github.com/mframework-zone/mframework"
      external large target="_blank"
    />
    ...
    <SettingsItem
      ...
      to="https://github.com/sponsors/mframework-zone"
