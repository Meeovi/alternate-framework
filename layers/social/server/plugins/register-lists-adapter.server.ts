...
export default defineNitroPlugin(() => {
  ...
  const graphqlEndpoint = process.env.LISTS_GRAPHQL_ENDPOINT || process.env.DIRECTUS_GRAPHQL
    ...
    registerAdapterEndpoint(
      {
        ...
        endpoint: () => {
          const endpoint = process.env.LISTS_GRAPHQL_ENDPOINT || process.env.DIRECTUS_GRAPHQL
          if (!endpoint) {
