        ...
        <div class="search-panel">
          ...
          <div class="search-panel__results">
            <div class="searchbox">
              ...
              <v-text-field v-if="isDev" v-model="searchQuery" placeholder="Search..." class="debug-search-input"
                append-inner-icon="fas fa-magnifying-glass" variant="solo-filled"></v-text-field>
            </div>
            <ais-hits>
...
<script setup lang="ts">
  ...
  const indexName = (configDetails?.public as any)?.search?.index || 'default';
