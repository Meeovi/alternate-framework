...
export function useCatalogFallback() {
  ...
  return {
    ...
    async getProductPrice(product: Record<string, any>, context: Record<string, unknown> = {}) {
      return pricing.getCatalogPriceForProduct(product, context)
    },
    async getCatalogPriceRules(context: Record<string, unknown> = {}) {
      return pricing.listCatalogPriceRules(context)
    },
    ...pricing,
  }
}
