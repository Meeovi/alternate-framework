                ...
                <div class="row justify-content-center">
                    <div class="card col-12 col-md-6 col-lg-4">
                        <div class="card-wrapper">
                            ...
                            <div class="card-box">
                                <h4 class="card-title mbr-fonts-style mb-2 display-7"><strong>Subscribed On</strong>
                                </h4>
                    ...
                    <div class="card col-12 col-md-6 col-lg-4">
                        <div class="card-wrapper">
                            ...
                            <div class="card-box">
                                <h4 class="card-title mbr-fonts-style mb-2 display-7"><strong>Subscription #</strong>
                                </h4>
                        ...
                        <div class="card-wrapper">
                            ...
                            <div class="card-box">
                                <h4 class="card-title mbr-fonts-style mb-2 display-7">
                                    <strong>View or Print Invoice</strong>
                                </h4>
                        ...
                        <div class="card-wrapper">
                            ...
                            <div class="text-wrapper">
                                ...
                                <p class="mbr-text mbr-fonts-style display-7">
                                    {{ subscription?.customer?.customers_id?.address }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="card col-12 col-md-6">
                        <div class="card-wrapper">
                            ...
                            <div class="text-wrapper">
                                ...
                                <p class="mbr-text mbr-fonts-style display-7">
                                    <NuxtLink to="mailto:info@site.com" class="text-primary">
                                        {{ subscription?.customer?.customers_id?.payment }}</NuxtLink>
                                </p>
                            </div>
                        </div>
                    </div>
