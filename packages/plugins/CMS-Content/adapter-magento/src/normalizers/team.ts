// packages/plugins/CMS-Content/adapter-magento/src/normalizers/team.ts
...
export const normalizeMagentoTeam: Normalizer<RawMagentoTeam, DirectusTeam> = createNormalizer<RawMagentoTeam, DirectusTeam>({
