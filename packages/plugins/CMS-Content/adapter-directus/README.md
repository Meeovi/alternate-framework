...
JSON
{
  ...
  "scripts": {
    "adapter:sync": "dotenv -- npm run --prefix ../../packages/plugins/CMS-Content/adapter-directus mesh:build"
  }
}
(Note: Adjust the relative path ../../packages/plugins/CMS-Content/adapter-directus to match your specific monorepo directory layout).
