...
// In edit mode the model holds the existing file's id/URL rather than a
// File — v-file-input only understands File objects.
const internalValue = computed(() =>
  typeof File !== 'undefined' && props.modelValue instanceof File ? [props.modelValue] : [])
