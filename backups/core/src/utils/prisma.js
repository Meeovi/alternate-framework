...
export function initializePrisma(PrismaClientClass) {
    ...
    if (!databaseUrl) {
        throw new Error('[@mframework/core] Neither DATABASE_URL nor NUXT_DATABASE_URL environment variable is set. ' +
...
export function getPrisma() {
    if (!prismaInstance && !globalForPrisma.__mframework_prisma) {
        throw new Error('[@mframework/core] Prisma not initialized. ' +
