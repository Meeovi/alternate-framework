...
export function useMFrameworkContext(): MFrameworkContext {
  if (!currentContext) {
    throw new Error('[@mframework/core] useMFrameworkContext() called before app initialization')
  }
...
export function useMFrameworkEventBus(): MFrameworkEventBus {
  if (!currentEventBus) {
    throw new Error('[@mframework/core] useMFrameworkEventBus() called before app initialization')
  }
